...
# data
df = pd.read_json('steps-sydney-time.json')
...
def update_graph(start_date, end_date):
    dff = df.query("dateTime > @start_date & dateTime < @end_date")
    graph = px.bar(dff, x="dateTime", y="value", labels={"dateTime": "Date", "value": "Steps"})
